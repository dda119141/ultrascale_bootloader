 ...
 *
 * This is the image header file which contains definitions for the image
 *header.
 *
 * <pre>
...
#define XIH_BH_MAX_SIZE (XIH_BH_MIN_SIZE + (0x00000182U * 4))
/**
...
u32 XFsbl_GetChecksumType(const XFsblPs_PartitionHeader* const PartitionHeader);
