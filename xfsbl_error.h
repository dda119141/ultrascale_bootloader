...
#define XFSBL_ERROR_STAGE_1_INIT_FAILED (0x0000U)
#define XFSBL_ERROR_STAGE_2_BOOTDEVICE_INIT_FAILED (u32)(0x2000U)
#define XFSBL_ERROR_STAGE_3_PARTITION_LOAD_FAILED (u32)(0x4000U)
#define XFSBL_ERROR_HANDOFF_FAILED (u32)(0x6000U)
...
#define STATUS_PARTITION_LOAD_IN_PROGRESS (0x3U)
...
#define XFSBL_ERROR_HANDOFF_FAILED_CPUID (0x23U)
