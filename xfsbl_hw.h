...
#define ADMA_CH0_ZDMA_CH_CTRL0_TOTAL_BYTE_COUNT \
	((ADMA_CH0_BASEADDR) + 0X00000188U)
...
/* Definition for PL clear include irrespective of boot image has bitstream or
 * not */
 ...
 *
 *****************************************************************************/
#define XFsbl_ReadReg(BaseAddr, RegOffset) Xil_In32((BaseAddr) + (RegOffset))
